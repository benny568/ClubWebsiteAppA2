System.register(['angular2/platform/browser', 'angular2/router', './app.component', 'angular2/http', '/app/services/session-data.service', '/app/services/server-data.service'], function(exports_1, context_1) {
    "use strict";
